...
<template>
  <Layout>
    ...
    <div class="row">
      <div class="col-6">
        <BForm class="app-search">
          <div class="position-relative">
            <input @input="searchProducts(page)" type="search" v-model="searchModel" class="form-control"
      ...
      <div class="col-6"><a style="float: right;" href="javascript:void(0)" @click="preAddProduct()"><i
            class="bx bx-plus bx-md"></i></a></div>
    </div>
